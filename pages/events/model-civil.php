...
<head>
  <title>Dristi 2.0: Model Competition(Civil)</title>
  <meta charset="utf-8">
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
        <div class="col-md-9 ftco-animate pb-5">
          <!-- todo -->
          <h1 class="mb-3 bread">Model Competition(Civil)</h1>
          <p class="breadcrumbs">
            <span class="mr-2"> <a href="/">Home <i class="ion-ios-arrow-forward"></i></a></span>
            <span class="mr-2"> <a href="/events">Events <i class="ion-ios-arrow-forward"></i></a></span>
            <span>Model Competition(Civil)<i class="ion-ios-arrow-forward"></i></span></p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10 order-md-last ftco-animate">
          ...
          <ul>
            <li style="color:#373c41;">The model should be related to civil engineering theme. </li>
            <li style="color:#373c41;">The physical model of the civil engineering structure shall be scaled down to suitable scale. </li>
            <li style="color:#373c41;">Abstract must be presented explaining the objectives, key contributions and lessons learned not exceeding 5 pages for model competition.</li>
            <li style="color:#373c41;">A poster of 42”X30” illustrating title, theme and schematic diagram of presented model should be submitted.</li>
          </ul>

          <h2 class="mb-3 mt-5">Registration Information:</h2>
          <ul>
            <li style="color:#373c41;">A team must register their names for ‘MODEL COMPETITION’ with entry fee of NRs. 4000 by filling up the registration form given by the organizer.</li>
            <li style="color:#373c41;">A team will consist of at most 6(six) members and can include members from different institute as well.</li>
          ...
          <ul>
            ...
            <li style="color:#373c41;">Winner will be awarded with Rs. 15,000 cash prize, runner up and second runner up will be awarded with Rs. 10,000 and Rs. 5,000 respectively.</li>
