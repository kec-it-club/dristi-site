...
<head>
  <title>Dristi 2.0 : Quick Code</title>
  <meta charset="utf-8">
      ...
      <div class="row">
        ...
        <div class="col-md-10 order-md-last ftco-animate">
          ...
          <ul>
            ...
            <li style="color:#373c41;"> <b>Participation</b>: +2/BCT/BEX Students individually 
            </li>
            ...
            <li style="color:#373c41;"> <b>Prize Distribution</b>: As the ​participants solve the problem 
          ...
          <ul>
            <li style="color:#373c41;"> Entry fee (as per your wish ranging from Rs. 20 to Rs. 50) and forms should be filled at site. 

            </li>
            <li style="color:#373c41;"> Participants will participate individually. </li>
          ...
          <ul>
            <li style="color:#373c41;">Cash prize for the participants who solve the problems.
              </li>
          </ul>
