...
<head>
  <title>Dristi 2.0: Model Competition(Electrical)</title>
  <meta charset="utf-8">
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
        <div class="col-md-9 ftco-animate pb-5">
          <!-- todo -->
          <h1 class="mb-3 bread">Model Competition(Electrical) </h1>
          <p class="breadcrumbs">
            <span class="mr-2"> <a href="/">Home <i class="ion-ios-arrow-forward"></i></a></span>
            <span class="mr-2"> <a href="/events">Events <i class="ion-ios-arrow-forward"></i></a></span>
            <span>Model Competition(Electrical)<i class="ion-ios-arrow-forward"></i></span></p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10 order-md-last ftco-animate">
          ...
          <p>
            <img src="/images/events/electrical-models.jpg" alt="" class="img-fluid">
          </p>

          <p style="color:#373c41;">
          Open model Demonstration is a event that provides the participants with a platform to present their projects/models in specified theme. The main objective of this event is to get the projects of the students out in the open in front of a live audience and get the feedback about the project/models from the audiences.
           The projects/models can also be any minor/major projects/models.
          </p>

          <h2 class="mb-3 mt-5">Participation Procedure:</h2>
          <ul>
            <li style="color:#373c41;">Full model to demonstrate.</li>
          ...
          <ul>
            <li style="color:#373c41;"> <b>Winner </b>: Rs. 10,000 </li>
