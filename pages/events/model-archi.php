...
<head>
  <title>Dristi 2.0: Model Competition (Architecture)</title>
  <meta charset="utf-8">
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
        <div class="col-md-9 ftco-animate pb-5">
          <!-- todo -->
          <h1 class="mb-3 bread">Model Competition (Architecture)</h1>
          <p class="breadcrumbs">
            <span class="mr-2"> <a href="/">Home <i class="ion-ios-arrow-forward"></i></a></span>
            <span class="mr-2"> <a href="/events">Events <i class="ion-ios-arrow-forward"></i></a></span>
            <span>Model Competition (Architecture)<i class="ion-ios-arrow-forward"></i></span></p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10 order-md-last ftco-animate">
          ...
          <p>
            <img src="/images/events/model making.jpg" alt="" class="img-fluid">
          </p>

          <h2 class="mb-3 mt-5">Event Details:</h2>
          <ul>
            <li style="color:#373c41;"> <b>Venue</b>: Kathmandu Engineering College</li>
            <li style="color:#373c41;"> <b>Participation</b>:  For the students of Bachelors of Architecture (Single or pair work.) </li>
            <li style="color:#373c41;"> <b>Entry Fee</b>: Rs. 200 (to be paid at the time of submission)  </li>
            <li style="color:#373c41;"> <b>Type of Event</b>: Level wise competition</li>
          ...
          <ul>
            <li style="color:#373c41;"> <b>Winner </b>: Rs.5,000 for both Levels  </li>
          </ul>
