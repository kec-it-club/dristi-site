...
<head>
  <title>Dristi 2.0: Spoken Word Poetry Competition</title>
  <meta charset="utf-8">
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
        <div class="col-md-9 ftco-animate pb-5">
          <!-- todo -->
          <h1 class="mb-3 bread"> Spoken Word Poetry Competition</h1>
          <p class="breadcrumbs">
            <span class="mr-2"> <a href="/">Home <i class="ion-ios-arrow-forward"></i></a></span>
            <span class="mr-2"> <a href="/events">Events <i class="ion-ios-arrow-forward"></i></a></span>
            <span> Spoken Word Poetry Competition<i class="ion-ios-arrow-forward"></i></span></p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row">
        ...
        <div class="col-md-10 order-md-last ftco-animate">
          ...
          <ul>
            ...
            <li style="color:#373c41;"> <b>Participation</b>:  Open to students of KEC, Kalimati  </li>
            <!-- <li style="color:#373c41;"> <b>Entry Fee</b>: Rs. 250 (to be paid at the time of submission)  </li> -->
            <li style="color:#373c41;"> <b>Type of Event</b>: Intra-College competition</li>
            <!-- <li style="color:#373c41;"> <b>Submission Deadline</b>:  Asad 18, 2076 at Department of Architecture by 4:00pm </li> -->
          </ul>

          <br><br>
          <p style="color:#373c41;"><i>Information regarding the dates, titles, topics, rules, registration fees and awards shall be provided in the official page of AKAR (@kecAKAR) and official website and page of Dristi 2.0 on facebook.</i></p>
          ...
          <ul>
            ...
            <li style="color:#373c41;">Aachal Pokhrel </li>
          </ul>
        </div>
      </div>
    </div>
