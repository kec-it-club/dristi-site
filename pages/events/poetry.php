    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10 order-md-last ftco-animate">
          ...
          <p>
            <img src="/images/events/poetry_competition.jpg" alt="" class="img-fluid">
          </p>

          <h2 class="mb-3 mt-5">General Specification:</h2>
          <ul>
            <li style="color:#373c41;">The poem can be of any topic and any language.</li>
            <li style="color:#373c41;">The poem should be written and owned by the presenter.</li>
            <li style="color:#373c41;">The participant must go through qualification round for participating in the final.</li>
            <li style="color:#373c41;">The qualification round will be organized by CESA on the specified date.</li>
            <li style="color:#373c41;">Theme, subject matter, creativity, literature work will be looked upon for judgement.</li>
          </ul>

          <h2 class="mb-3 mt-5">Registration Information:</h2>
          <ul>
            <li style="color:#373c41;">A participant must register his/her name for ‘POETRY EVENT’ with entry fee of NRs. 500 for engineering students and Rs. 100 for plus 2 
            students by filling up the registration form given by the organizer. </li>
          </ul>
          ...
          <ul>
            ...
            <li style="color:#373c41;">Winner will be awarded with Rs. 5000 cash prize and runner ups will be awarded with Rs. 4000 and Rs. 3000 respectively.</li>
